...
draft: false
---
I'd been looking for a project to work on to learn Python and AI when I came across a video about [Neural network racing cars around a track](https://www.youtube.com/watch?v=wL7tSgUpy8w). Initially, I thought creating something like that would be too hard for a first project in Python, so I started work on it.
...
You can find the code and a video of the car driving on [Github](https://github.com/mikebarram/Not-AI-Car/)