...
[![](images/jwt1.png)](https://mikebarram.files.wordpress.com/2022/08/jwt1.png)
...
[![](images/jwt2.png)](https://mikebarram.files.wordpress.com/2022/08/jwt2.png)

The JavaScript in my (single page) application gets the token and stores it for use later on:

[![](images/jwt9.png)](https://mikebarram.files.wordpress.com/2022/08/jwt9.png)
