...
In a [previous post](https://mikebarram.wordpress.com/2014/02/27/multiline-text-editor-in-mvc/) I showed how you could set attributes on properties in an MVC model so that a text field would be edited with a multi-line HTML text box, instead of a single line input field.
...
[![UIhint](images/UIhint.png)](https://mikebarram.files.wordpress.com/2014/03/UIhint.png)
